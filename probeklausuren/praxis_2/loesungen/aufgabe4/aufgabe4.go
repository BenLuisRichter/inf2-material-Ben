...
// NodesWithDistance soll eine Liste aller Knoten liefern,
// die in genau d Schritten von n aus erreichbar sind.
// Die Liste soll keine Duplikate enthalten,
// sie muss aber nicht sortiert sein.
